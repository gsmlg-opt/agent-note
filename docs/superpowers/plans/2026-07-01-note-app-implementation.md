...
2. Download the BGE-M3 int8-quantized ONNX model into the expected local path:
   ```sh
   ...
   without this model, using a stub embedder — only the real `OrtEmbedder` needs it.
